...
private static Integer minDiff;
	...
	public static void main(String[] args) {
		...
		MinDistanceBtwnTwoNodes binaryTree = new MinDistanceBtwnTwoNodes();
		...
		{
			minDiff=inOrderList.get(1)-inOrderList.get(0);
			for(int i=1;i<inOrderList.size()-1;i++)
			{
				if(minDiff>(inOrderList.get(i+1)-inOrderList.get(i)))  //change sign > to < to get maxDistance
					minDiff=inOrderList.get(i+1)-inOrderList.get(i);
			}
